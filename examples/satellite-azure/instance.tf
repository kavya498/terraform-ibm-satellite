...
resource "azurerm_linux_virtual_machine" "az_host" {
  ...
  custom_data           = base64encode(module.satellite-location.host_script) // custom_data will be referenced from ibm_satellite_attach_host_script datasource in future.
